...
- **Add packages** - Go to Packages page to create sponsorship packages
- **Create proposals** - Use Proposals to send offers to sponsors
- **Track analytics** - View Analytics for sponsor performance insights
- **Build packages** - Use Package Builder for custom sponsor offerings

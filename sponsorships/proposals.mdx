---
title: 'Sponsorship Proposals - Send Offers & Track Status | Valiyou™'
...
<Frame>
  <img src="/images/proposals-dashboard.png" alt="Sponsorship proposals dashboard showing sent offers, pending approvals, proposal tracking status, sponsor responses, and branded PDF documents with real-time status updates and audit trails" />
</Frame>
...
<Info>
**Lifecycle Tracking**: Each proposal maintains complete history from creation through final decision, with timestamps, IP addresses, and sponsor actions recorded for compliance and analysis.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card
    title="Follow Up"
    icon="phone"
    href="/sponsorships/sponsors#contacts"
  >

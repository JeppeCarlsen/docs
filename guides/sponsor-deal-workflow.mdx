...
'og:title': 'Close Your First Sponsorship Deal | Valiyou'
---
...
<Note>
  **Time Required**: 30-45 minutes (first-time setup) **Plan Required**: Professional or Enterprise
  plan **Permissions Required**: Sponsors, Inventory, Packages, and Proposals permissions
</Note>
...
<Tip>
  **Pro Tip**: Add notes about sponsor preferences, past conversations, or specific interests. This
  helps customize your proposal later.
</Tip>
...
<Info>
  **Inventory Strategy**: Start with 10-15 core items. You can always add more later. Focus on
  high-value, high-visibility assets first.
</Info>
...
<Tip>
  **Follow Up**: Send a personal email or call 2-3 days after sending to answer questions and gauge
  interest.
</Tip>

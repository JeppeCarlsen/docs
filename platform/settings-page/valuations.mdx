---
title: 'Valuation Settings - Default Brand Value Indicators | Valiyou'
description: 'Configure default brand value indicators (BVI) for new valuations in Valiyou. Set baseline values for popularity, CSR, culture, and loyalty metrics. Professional and Enterprise plan feature for consistent valuation methodology.'
---

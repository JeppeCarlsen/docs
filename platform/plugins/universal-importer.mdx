...
<Frame>
  <img src="/images/platform/plugins/importer-file-upload.png" alt="CSV file upload interface for bulk upload of sponsor and contact data with drag-and-drop support" />
</Frame>

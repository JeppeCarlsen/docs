...
2. If at limit:
   ...
   - **Option 2**: Purchase additional seats via [Platform → Billing](/platform/billing)
   - **Option 3**: Upgrade plan via [Platform → Billing](/platform/billing)
...
- Purchase additional seats via [Platform → Billing](/platform/billing)
- Upgrade plan via [Platform → Billing](/platform/billing)

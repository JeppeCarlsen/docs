---
title: 'Audit Log'
description: 'Track all data changes with comprehensive audit trail for compliance and security'
---
...
Navigate to **Platform** → **Settings** → **Advanced** tab → Click **"View Audit Log"** button.

Or directly: **Platform** → **Audit Log** from the sidebar.
...
- **Review Regularly**: Check audit log weekly for unusual activity
- **Export for Compliance**: Schedule quarterly exports for audit records
- **Train Team**: Educate team about audit log and accountability
- **Set Up Alerts**: Request alert notifications for critical changes (contact support)
- **Document Processes**: Use audit log to document change management

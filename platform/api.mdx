---
title: 'API Keys - REST API Authentication & Documentation | Valiyou'
description: 'Create and manage API keys for secure REST API access to Valiyou data. Generate authentication tokens, monitor API usage, integrate with Power BI and Excel, and explore comprehensive endpoint documentation with examples.'
---
...
<AccordionGroup>
  ...
  <Accordion title="How do I integrate Valiyou API with Power BI?">
    Create an API key with GET operation and required scopes, open Power BI Desktop, select Get Data → Web, enter your API endpoint URL with the api_key and club_id parameters (e.g., https://valiyou.com/api/v1/valuations?api_key=YOUR_KEY&club_id=YOUR_ID), transform the data in Power Query Editor, and create your visualizations. You can set up scheduled refresh to keep your reports automatically updated.
  </Accordion>
...
<script type="application/ld+json">
{
  ...
  "step": [
    ...
    },
    {
      ...
      "text": "Include the API key in your requests using the api_key parameter: https://valiyou.com/api/v1/valuations?api_key=YOUR_KEY&club_id=YOUR_ID",
      "position": 5
    }
  ]
}
